...
public class JuliToLog4JHandler extends Handler {
	...
	public void publish(LogRecord record) {
		...
		log.log(java.util.logging.Logger.class.getName(), level,
	...
	protected org.apache.log4j.Level toLog4jLevel(Level juliLevel) {
		if (Level.OFF.equals(juliLevel)) {
		...
		} else if (Level.CONFIG.equals(juliLevel)
				|| Level.FINE.equals(juliLevel)) {
			return org.apache.log4j.Level.DEBUG;
		} else if (Level.FINER.equals(juliLevel)
				|| Level.FINEST.equals(juliLevel)) {
			...
			LogLog.warn(
					"Warning: usage of custom JULI level: "
							+ juliLevel.getName(), new Exception());
			...
			return new CustomLog4jLevel(juliLevel.intValue(),
					juliLevel.getName(), juliLevel.intValue());
		}
	}
	...
	protected static class CustomLog4jLevel extends org.apache.log4j.Level {
		 ...
		 */
		protected CustomLog4jLevel(int level, String levelStr,
