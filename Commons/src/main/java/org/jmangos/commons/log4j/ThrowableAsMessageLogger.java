...
public class ThrowableAsMessageLogger extends Logger {
     ...
     *            logger's name
     */
    protected ThrowableAsMessageLogger(final String name) {
    
        super(name);
    }
    
    /**
     * This method checks if message is instance of throwbale and throwable is null. If it is so it
     * will move message to throwable and set localized message of throwable as message of the log
     * record
     * 
     * @param fqcn
     ...
     */
    @Override
    protected void forcedLog(final String fqcn, final Priority level, Object message, Throwable t) {
