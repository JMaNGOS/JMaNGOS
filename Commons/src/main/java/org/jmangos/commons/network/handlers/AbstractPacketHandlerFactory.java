...
public abstract class AbstractPacketHandlerFactory extends XmlDataLoader
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(AbstractPacketHandlerFactory.class);
    /** The c handler. */
    ...
    static final class AddUpstreamPackets extends AddPackets {
        ...
        public boolean execute(final int number, final PacketTemplate template) {
            ...
            try {
                this.packetHandlerFactory.addPacket(
                        this.classLoader.loadClass(fullPath).asSubclass(SendablePacket.class),
