...
public class CommonThreadPoolManager implements ThreadPoolManager {
    ...
    /**
     * @see org.jmangos.commons.threadpool.ThreadPoolManager#schedule(java.lang.Runnable,
     *      long)
     */
    @Override
    public final ScheduledFuture<?> schedule(final Runnable r, final long delay) {

        return this.scheduledPool.schedule(new TaskExecutionWrapper(r), validate(delay),
     ...
     */
    @Override
    public final ScheduledFuture<?> scheduleAtFixedRate(final Runnable r, final long delay,
            final long period) {

        return this.scheduledPool.scheduleAtFixedRate(new TaskExecutionWrapper(r), validate(delay),
