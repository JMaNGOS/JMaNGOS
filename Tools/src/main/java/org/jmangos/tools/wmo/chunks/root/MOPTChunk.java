...
public class MOPTChunk extends WMOChunk {
    ...
    private String getAllName() {
        ...
        for (final MOPTEntry moptEntrie : this.MOPTEntries) {
            tmp += "\n\tBaseVertex:" + moptEntrie.BaseVertex.get() + "\n\tcountVert:" + moptEntrie.countVert.get() + "\n\tvector:" + moptEntrie.vector[0].get()
                    + " " + moptEntrie.vector[1].get() + " " + moptEntrie.vector[2].get() + "\n\tunknown:" + moptEntrie.unknown.get();
