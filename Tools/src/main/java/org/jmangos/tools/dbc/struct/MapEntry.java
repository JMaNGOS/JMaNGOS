...
public class MapEntry extends DBCStruct<MapEntry> {
    ...
    /**
     * <code>59</code> map_id of entrance map in ghost mode (continent always and in most cases =
     * normal entrance)
     */
    @XmlAttribute(name = "ghostEntranceMap", required = true)
    public final Signed32            ghostEntranceMap        = new Signed32();
    
    /** <code>60</code> entrance x coordinate in ghost mode (in most cases = normal entrance) */
    @XmlAttribute(name = "ghostEntranceX", required = true)
    public final Float32             ghostEntranceX          = new Float32();
    
    /** <code>61</code> entrance y coordinate in ghost mode (in most cases = normal entrance) */
