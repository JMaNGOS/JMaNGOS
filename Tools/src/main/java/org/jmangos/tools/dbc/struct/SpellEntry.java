...
public class SpellEntry extends DBCStruct<SpellEntry> {
    ...
    public final Unsigned32          Category                      = new Unsigned32();         // 1
                                                                                                // m_category
    @XmlAttribute(name = "Dispel", required = true)
    public final Unsigned32          Dispel                        = new Unsigned32();         // 2
                                                                                                // m_dispelType
    @XmlAttribute(name = "Mechanic", required = true)
    public final Unsigned32          Mechanic                      = new Unsigned32();         // 3
                                                                                                // m_mechanic
    @XmlAttribute(name = "Attributes", required = true)
    public final Unsigned32          Attributes                    = new Unsigned32();         // 4
                                                                                                // m_attribute
    @XmlAttribute(name = "AttributesEx", required = true)
    public final Unsigned32          AttributesEx                  = new Unsigned32();         // 5
                                                                                                // m_attributesEx
    ...
    public final Unsigned32          Stances                       = new Unsigned32();         // 12
                                                                                                // m_shapeshiftMask
    public final Unsigned32          unk_320_1                     = new Unsigned32();         // 13
                                                                                                // 3.2.0
    @XmlAttribute(name = "StancesNot", required = true)
    public final Unsigned32          StancesNot                    = new Unsigned32();         // 14
                                                                                                // m_shapeshiftExclude
    public final Unsigned32          unk_320_2                     = new Unsigned32();         // 15
                                                                                                // 3.2.0
    @XmlAttribute(name = "Targets", required = true)
    public final Unsigned32          Targets                       = new Unsigned32();         // 16
                                                                                                // m_targets
    ...
    public final Unsigned32          procFlags                     = new Unsigned32();         // 34
                                                                                                // m_procTypeMask
    @XmlAttribute(name = "procChance")
    public final Unsigned32          procChance                    = new Unsigned32();         // 35
                                                                                                // m_procChance
    @XmlAttribute(name = "procCharges")
    public final Unsigned32          procCharges                   = new Unsigned32();         // 36
                                                                                                // m_procCharges
    @XmlAttribute(name = "maxLevel")
    public final Unsigned32          maxLevel                      = new Unsigned32();         // 37
                                                                                                // m_maxLevel
    @XmlAttribute(name = "baseLevel", required = true)
    public final Unsigned32          baseLevel                     = new Unsigned32();         // 38
                                                                                                // m_baseLevel
    @XmlAttribute(name = "spellLevel", required = true)
    public final Unsigned32          spellLevel                    = new Unsigned32();         // 39
                                                                                                // m_spellLevel
    ...
    public final Unsigned32          powerType                     = new Unsigned32();         // 41
                                                                                                // m_powerType
    @XmlAttribute(name = "manaCost", required = true)
    public final Unsigned32          manaCost                      = new Unsigned32();         // 42
                                                                                                // m_manaCost
    ...
    public final Unsigned32          rangeIndex                    = new Unsigned32();         // 46
                                                                                                // m_rangeIndex
    ...
    public final Unsigned32[]        Totem                         = array(new Unsigned32[2]); // 50-51
                                                                                                // m_totem
    ...
    public final Unsigned32          SpellIconID                   = new Unsigned32();         // 133
                                                                                                // m_spellIconID
    ...
    public final Unsigned32          SchoolMask                    = new Unsigned32();         // 225
                                                                                                // m_schoolMask
    @XmlAttribute(name = "runeCostID", required = true)
    public final Unsigned32          runeCostID                    = new Unsigned32();         // 226
                                                                                                // m_runeCostID
    ...
    public final Unsigned32          SpellDifficultyId             = new Unsigned32();         // 233
                                                                                                // 3.3.0
}
