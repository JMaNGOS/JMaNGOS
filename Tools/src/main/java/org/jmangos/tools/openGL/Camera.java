...
public final class Camera {
    ...
    public final void setPosition(final float positionX, final float positionY, final float positionZ, final float viewX, final float viewY, final float viewZ,
    ...
    private final void mouse_view() {
        ...
        if (this.currentRotX > 90.0f) {
            ...
            vAxis = Vector3f.cross(Vector3f.sub(this.m_vView, this.m_vPosition, null), this.m_vUpVector, null);
            vAxis.normalise();
    ...
    private final void rotate(final float angle, final float x, final float y, final float z) {
        ...
        vView.x = this.m_vView.x - this.m_vPosition.x; // This gets the direction of the
        // X.
        vView.y = this.m_vView.y - this.m_vPosition.y; // This gets the direction of the
        // Y.
        vView.z = this.m_vView.z - this.m_vPosition.z; // This gets the direction of the
        // Z.
    ...
    private final void rotateWithQuaternion(final float angleDir, final float xSpeed, final float ySpeed, final float zSpeed) {
        ...
        // and position.
        qView.x = this.m_vView.x - this.m_vPosition.x; // This gets the direction of the
        // X.
        qView.y = this.m_vView.y - this.m_vPosition.y; // This gets the direction of the
        // Y.
        qView.z = this.m_vView.z - this.m_vPosition.z; // This gets the direction of the
        // Z.
        qView.w = 0;
    ...
    public final void update() {
        ...
        this.m_vStrafe = Vector3f.cross(Vector3f.sub(this.m_vView, this.m_vPosition, null), this.m_vUpVector, null);
    ...
    public final void look() {
        ...
        gluLookAt(this.m_vPosition.x, this.m_vPosition.y, this.m_vPosition.z, this.m_vView.x, this.m_vView.y, this.m_vView.z, this.m_vUpVector.x, this.m_vUpVector.y, this.m_vUpVector.z);
    }
