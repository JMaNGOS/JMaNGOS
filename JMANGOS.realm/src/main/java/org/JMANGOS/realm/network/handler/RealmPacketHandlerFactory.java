...
import org.JMANGOS.common.network.handlers.ClientPacketHandler;
import org.JMANGOS.common.network.handlers.ServerPacketHandler;
 ...
 */
public class RealmPacketHandlerFactory extends XmlDataLoader
	...
	public void addList(PacketData pl) {
		ClassLoader cl = RealmPacketHandlerFactory.class.getClassLoader();
		for (PacketList plist : pl.templates) {
			switch (plist.getDirection()) {
			case DOWNSTREAM:
				for (Object pt : plist.data.getValues()) {
					try {
