 ...
 * <p>
 * <ol>
 * <li><b>Class:</b> <tt>SkillRaceClassSpecs</tt> contains specification for
 * {@link SkillRaceClassInfoEntity}
 * <ol>
 * <b>Specifications:</b>
 * <li>isRaceMatchToRaceMask
 * <li>isClassMatchToClassMask
 * </ol>
 * <li><b>Used in: {@link org.jmangos.world.services.impl.SkillServiceImpl}</b>
 * </ol>
 * </p>
 * 
 * @author MinimaJack
...
public class SkillRaceClassSpecs {
    ...
    public static Specification<SkillRaceClassInfoEntity> isClassMatchToClassMask(
            final Classes clazz) {
        return new Specification<SkillRaceClassInfoEntity>() {
