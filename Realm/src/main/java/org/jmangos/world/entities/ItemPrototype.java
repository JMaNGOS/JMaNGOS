...
public class ItemPrototype extends NamedObject {
    ...
    // @Basic
    // @Column(name = "stat_type1", nullable = false, insertable = true, updatable = true, length =
    // 3, precision = 0)
    /** item stats. */
    @Transient
     ...
     * @Columns(columns = {
     * 
     * @Column(name = "dmg_min1", nullable = false, insertable = true, updatable = true, length =
     * 12, precision = 0),
     * 
     * @Column(name = "dmg_max1", nullable = false, insertable = true, updatable = true, length =
     * 12, precision = 0),
     * 
     * @Column(name = "dmg_type1", nullable = false, insertable = true, updatable = true, length =
     * 3, precision = 0),
     * 
     * @Column(name = "dmg_min2", nullable = false, insertable = true, updatable = true, length =
     * 12, precision = 0),
     * 
     * @Column(name = "dmg_max2", nullable = false, insertable = true, updatable = true, length =
     * 12, precision = 0),
     * 
     * @Column(name = "dmg_type2", nullable = false, insertable = true, updatable = true, length =
     * 3, precision = 0), })
     */
    @Transient
    ...
    /*
     * private int[] SpellId = new int[MAX_ITEM_PROTO_SPELLS]; private byte[] SpellTrigger = new
     * byte[MAX_ITEM_PROTO_SPELLS]; private int[] SpellCharges = new int[MAX_ITEM_PROTO_SPELLS];
     * private float[] SpellPPMRate = new float[MAX_ITEM_PROTO_SPELLS]; private int[] SpellCooldown
    ...
    // @Column(name = "socketColor_1", nullable = false, insertable = true, updatable = true, length
    // = 3, precision = 0)
     ...
     *            the pos
     */
    public void setDamage(final float damageMin, final float damageMax, final byte damageType, final byte pos) {
     ...
     */
    /*
     * public void setSpells(int _SpellId, byte _SpellTrigger, int _SpellCharges, float
     * _SpellPPMRate, int _SpellCooldown, int _SpellCategory, int _SpellCategoryCooldown, byte pos)
     * { SpellId[pos] = _SpellId; SpellTrigger[pos] = _SpellTrigger; SpellCharges[pos] =
     * _SpellCharges; SpellPPMRate[pos] = _SpellPPMRate; SpellCooldown[pos] = _SpellCooldown;
     * SpellCategory[pos] = _SpellCategory; SpellCategoryCooldown[pos] = _SpellCategoryCooldown; }
     */
    /**
     * @return the bonding
     */
