...
import org.jmangos.realm.dao.PlayerLevelInfoDao;
import org.jmangos.realm.entities.PlayerLevelInfo;
import org.jmangos.realm.services.PlayerLevelInfoService;
...
public class PlayerLevelInfoServiceImpl implements PlayerLevelInfoService {
    ...
    @Override
    public PlayerLevelInfo readPlayerLevelInfo(final Integer id) {
    
        return this.playerLevelInfoDao.readPlayerLevelInfo(id);
    }
    ...
    @Override
    public Integer createOrUpdatePlayerLevelInfo(final PlayerLevelInfo playerLevelInfo) {
