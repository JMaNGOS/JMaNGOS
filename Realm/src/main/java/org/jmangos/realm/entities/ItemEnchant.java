...
public class ItemEnchant implements Serializable {
    ...
    @Column(name = "enchantId", nullable = false, insertable = true, updatable = true, length = 3, precision = 0)
    private int               enchantId;
    
    @Column(name = "duration", nullable = false, insertable = true, updatable = true, length = 3, precision = 0)
