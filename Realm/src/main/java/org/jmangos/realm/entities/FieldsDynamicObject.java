...
public class FieldsDynamicObject extends FieldsObject {
    ...
    @Column(name = "caster", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    private long  caster;
    
    @Column(name = "bytes", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int   bytes;
    
    @Column(name = "spellId", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int   spellId;
    
    @Column(name = "radius", nullable = false, insertable = true, updatable = true, length = 8, precision = 0)
    private float radius;
    
    @Column(name = "castTime", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
