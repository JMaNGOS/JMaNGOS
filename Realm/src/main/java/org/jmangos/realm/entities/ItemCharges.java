...
public class ItemCharges implements Serializable {
    ...
    @Id
    @Column(name = "itemGuid", nullable = false, insertable = true, updatable = true, length = 3, precision = 0)
    private long              itemGuid;
    
    @Id
    @Column(name = "slot", nullable = false, insertable = true, updatable = true, length = 3, precision = 0)
    private byte              slot;
    
    @Column(name = "charges", nullable = false, insertable = true, updatable = true, length = 3, precision = 0)
    private int               charges;
    ...
    public boolean equals(final Object obj) {
        ...
        return (((ItemCharges) obj).getItemGuid() == getItemGuid()) && (((ItemCharges) obj).getSlot() == getSlot());
    }
