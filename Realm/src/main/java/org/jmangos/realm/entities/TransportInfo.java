...
public class TransportInfo {
    ...
    @Column(name = "transportEntry", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    private int  transportEntry;
    
    @Column(name = "seat", nullable = true, insertable = true, updatable = true, length = 3, precision = 0)
    private byte seat;
    
    @Embedded
    @AttributeOverrides({ @AttributeOverride(name = "x", column = @Column(name = "trans_position_x")),
