...
public class FieldsCorpse extends FieldsObject {
    ...
    @Column(name = "owner", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    private long owner;
    
    @Column(name = "party", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    private long party;
    
    @Column(name = "displayId", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int  displayId;
    
    @Column(name = "bytes1", nullable = false, insertable = true, updatable = true, length = 8, precision = 0)
    private int  bytes1;
    
    @Column(name = "bytes2", nullable = false, insertable = true, updatable = true, length = 8, precision = 0)
    private int  bytes2;
    
    @Column(name = "guild", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int  guild;
    
    @Column(name = "flags", nullable = false, insertable = true, updatable = true, length = 8, precision = 0)
    private int  flags;
    
    @Column(name = "dynamicFlags", nullable = false, insertable = true, updatable = true, length = 8, precision = 0)
