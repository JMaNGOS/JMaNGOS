...
import org.jmangos.realm.model.enums.MovementFlags;
import org.jmangos.realm.model.enums.MovementFlags2;
import org.jmangos.realm.model.enums.UpdateFlags;

@DynamicUpdate
@Entity
@Table(name = "character_positioner")
public class CharacterPositionerHolder extends BasicPositionerHolder {
     ...
     * 
     * @see
     * org.jmangos.test.subentities.BasicMovementHolder#buildUpdateBlock(org.jboss.netty.buffer.
     * ChannelBuffer)
     */
    @Override
    public void buildUpdateData(final ChannelBuffer buffer) {
        ...
        if (MovementFlags.SWIMMING.contains(this.flags) || MovementFlags.FLYING.contains(this.flags) || MovementFlags2.ALLOWPITCHING.contains(this.extraFlags)) {
