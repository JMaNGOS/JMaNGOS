...
import org.jmangos.realm.model.enums.RestState;
import org.jmangos.realm.model.enums.VisibilityState;
...
public class FieldsCharacter extends FieldsUnit {
    ...
    /** 384 integer */
    @Transient
    private final int[]                    skillInfo           = new int[384];
    ...
    @Column(name = "exploredZones", nullable = true, insertable = true, updatable = true, length = 1024)
     ...
     */
    public final int getSkillInfo(final int index) {
     ...
     */
    public final void setSkillInfo(final int skillIndex, final int skillValue) {
    
        this.bitSet.set(PlayerFields.PLAYER_SKILL_INFO_1_1.getValue() + skillIndex);
        this.skillInfo[skillIndex] = skillValue;
    }
