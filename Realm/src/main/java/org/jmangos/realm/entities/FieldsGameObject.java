...
public class FieldsGameObject extends FieldsObject {
    ...
    @Column(name = "createdBy", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    ...
    @Column(name = "dynamic", nullable = false, insertable = true, updatable = true, length = 8, precision = 0)
    private int      dynamic;
    
    @Column(name = "faction", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int      faction;
    
    @Column(name = "level", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int      level;
    
    @Column(name = "bytes", nullable = false, insertable = true, updatable = true, length = 10, precision = 0)
    private int      bytes;
