...
public interface PlayerLevelInfoDao {
    
    public PlayerLevelInfo readPlayerLevelInfo(Integer id);
    
    public List<PlayerLevelInfo> readPlayerLevelInfos(final Criterion... criterions);
    
    public Integer createOrUpdatePlayerLevelInfo(PlayerLevelInfo playerLevelInfo);
