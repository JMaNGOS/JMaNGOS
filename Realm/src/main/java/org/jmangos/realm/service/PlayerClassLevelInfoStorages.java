...
public class PlayerClassLevelInfoStorages
        implements DataLoadService<HashMap<PlayerClassLevelInfoPK, PlayerClassLevelInfo>> {
    ...
    /** The Player cli. */
    private HashMap<PlayerClassLevelInfoPK, PlayerClassLevelInfo> playerCLI =
            new HashMap<PlayerClassLevelInfoPK, PlayerClassLevelInfo>();
    ...
    public HashMap<PlayerClassLevelInfoPK, PlayerClassLevelInfo> load() {
        ...
        final HashMap<PlayerClassLevelInfoPK, PlayerClassLevelInfo> map =
                new HashMap<PlayerClassLevelInfoPK, PlayerClassLevelInfo>();
        final List<PlayerClassLevelInfo> infoList =
                this.playerClassLevelInfoService.readPlayerClassLevelInfos();
