...
public class RealmToClientChannelHandler extends SimpleChannelUpstreamHandler {
     ...
     */
    public RealmToClientChannelHandler(final PacketHandlerFactory packetService,
            final ConnectHandler connectionHandler, final Netty2PacketReceiver netty2PacketReceiver) {
     ...
     * 
     * @see
     * org.jboss.netty.channel.SimpleChannelUpstreamHandler#channelDisconnected(org
     * .jboss.netty.
