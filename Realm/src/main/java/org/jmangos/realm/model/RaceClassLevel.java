...
public class RaceClassLevel extends ClassLevel {
     ...
     *            the level
     */
    public RaceClassLevel(final int race, final int clazz, final int level) {
    ...
    public boolean equals(final Object obj) {
        ...
        if ((((ClassLevel) obj).clazz == this.clazz) && (((ClassLevel) obj).level == this.level) && (((RaceClassLevel) obj).race == this.race)) {
            return true;
        }
        return false;
    }
