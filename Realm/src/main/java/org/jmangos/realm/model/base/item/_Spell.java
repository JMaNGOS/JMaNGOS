...
public final class _Spell {
     ...
     *            the spell category cooldown
     */
    public _Spell(final int spellId, final byte spellTrigger, final int spellCharges, final float spellPPMRate, final int spellCooldown,
            final int spellCategory, final int spellCategoryCooldown) {
