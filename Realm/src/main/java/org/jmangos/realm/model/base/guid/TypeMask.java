...
public enum TypeMask {
    ...
    final static EnumSet<TypeMask> TYPEMASK_CREATURE_OR_GAMEOBJECT             = EnumSet.of(TYPEMASK_UNIT, TYPEMASK_GAMEOBJECT);
    
    /** The Constant TYPEMASK_CREATURE_GAMEOBJECT_OR_ITEM. */
    final static EnumSet<TypeMask> TYPEMASK_CREATURE_GAMEOBJECT_OR_ITEM        = EnumSet.of(TYPEMASK_UNIT, TYPEMASK_GAMEOBJECT, TYPEMASK_ITEM);
    
    /** The Constant TYPEMASK_CREATURE_GAMEOBJECT_PLAYER_OR_ITEM. */
    final static EnumSet<TypeMask> TYPEMASK_CREATURE_GAMEOBJECT_PLAYER_OR_ITEM = EnumSet.of(TYPEMASK_UNIT, TYPEMASK_GAMEOBJECT, TYPEMASK_ITEM, TYPEMASK_PLAYER);
