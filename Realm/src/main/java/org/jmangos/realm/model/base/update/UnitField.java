...
public enum UnitField implements UpdateField {
    ...
    /** The UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER
     *  Flags: PRIVATE; OWNER
     */
    UNIT_FIELD_POWER_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0022, 7, FLOAT ),
    
    /** The UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER
     *  Flags: PRIVATE; OWNER
     */
    UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x0029, 7, FLOAT ),
    
    /** The UNIT_FIELD_LEVEL
     *  Flags: PUBLIC
     */
    UNIT_FIELD_LEVEL( OBJECT_END + 0x0030, 1, INT ),
