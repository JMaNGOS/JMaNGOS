...
public enum UnitField implements UpdateField {
    ...
    UNIT_FIELD_POWER_1_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0023, 1, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_2_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0024, 1, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_3_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0025, 1, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_4_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0026, 1, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_5_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0027, 1, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_6_REGEN_FLAT_MODIFIER( OBJECT_END + 0x0028, 1, FLOAT ), //; Flags: PRIVATE; OWNER
    ...
    UNIT_FIELD_POWER_1_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x002A, 7, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_2_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x002B, 7, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_3_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x002C, 7, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_4_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x002D, 7, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_5_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x002E, 7, FLOAT ), //; Flags: PRIVATE; OWNER
    UNIT_FIELD_POWER_6_REGEN_INTERRUPTED_FLAT_MODIFIER( OBJECT_END + 0x002F, 7, FLOAT ), //; Flags: PRIVATE; OWNER


    /** The UNI t_ fiel d_ level. */
    UNIT_FIELD_LEVEL( OBJECT_END + 0x0030, 1, INT ), //; Flags: PUBLIC
    
    /** The UNIT_FIELD_FACTIONTEMPLATE
     *  Flags: PUBLIC
     */
    UNIT_FIELD_FACTIONTEMPLATE( OBJECT_END + 0x0031, 1, INT ),
    
    /** The UNIT_VIRTUAL_ITEM_SLOT_ID
     *  Flags: PUBLIC
     */
    UNIT_VIRTUAL_ITEM_SLOT_ID( OBJECT_END + 0x0032, 3, INT ),
    
    /** The UNIT_FIELD_FLAGS
     *  Flags: PUBLIC
     */
    UNIT_FIELD_FLAGS( OBJECT_END + 0x0035, 1, INT ),
    
    /** The UNIT_FIELD_FLAGS_2
     *  Flags: PUBLIC
     */
    UNIT_FIELD_FLAGS_2( OBJECT_END + 0x0036, 1, INT ),
    
    /** The UNIT_FIELD_AURASTATE
     *  Flags: PUBLIC
     */
    UNIT_FIELD_AURASTATE( OBJECT_END + 0x0037, 1, INT ),
    
    /** The UNIT_FIELD_BASEATTACKTIME
     *  Flags: PUBLIC
     */
    UNIT_FIELD_BASEATTACKTIME( OBJECT_END + 0x0038, 2, INT ),
    
    /** The UNIT_FIELD_RANGEDATTACKTIME
     *  Flags: PRIVATE
     */
    UNIT_FIELD_RANGEDATTACKTIME( OBJECT_END + 0x003A, 1, INT ),
    
    /** The UNIT_FIELD_BOUNDINGRADIUS
     *  Flags: PUBLIC
     */
    UNIT_FIELD_BOUNDINGRADIUS( OBJECT_END + 0x003B, 1, FLOAT ),
    
    /** The UNIT_FIELD_COMBATREACH
     *  Flags: PUBLIC
     */
    UNIT_FIELD_COMBATREACH( OBJECT_END + 0x003C, 1, FLOAT ),
    
    /** The UNIT_FIELD_DISPLAYID
     *  Flags: PUBLIC
     */
    UNIT_FIELD_DISPLAYID( OBJECT_END + 0x003D, 1, INT ),
    
    /** The UNIT_FIELD_NATIVEDISPLAYID
     *  Flags: PUBLIC
     */
    UNIT_FIELD_NATIVEDISPLAYID( OBJECT_END + 0x003E, 1, INT ),
    
    /** The UNIT_FIELD_MOUNTDISPLAYID
     *  Flags: PUBLIC
     */
    UNIT_FIELD_MOUNTDISPLAYID( OBJECT_END + 0x003F, 1, INT ),
    
    /** The UNIT_FIELD_MINDAMAGE
     *  Flags: PRIVATE; OWNER; PARTY_LEADER
     */
    UNIT_FIELD_MINDAMAGE( OBJECT_END + 0x0040, 1, FLOAT ),
    
    /** The UNIT_FIELD_MAXDAMAGE
     *  Flags: PRIVATE; OWNER; PARTY_LEADER
     */
    UNIT_FIELD_MAXDAMAGE( OBJECT_END + 0x0041, 1, FLOAT ),
    
    /** The UNIT_FIELD_MINOFFHANDDAMAGE
     *  Flags: PRIVATE; OWNER; PARTY_LEADER
     */
    UNIT_FIELD_MINOFFHANDDAMAGE( OBJECT_END + 0x0042, 1, FLOAT ),
    
    /** The UNIT_FIELD_MAXOFFHANDDAMAGE
     *  Flags: PRIVATE; OWNER; PARTY_LEADER
     */
    UNIT_FIELD_MAXOFFHANDDAMAGE( OBJECT_END + 0x0043, 1, FLOAT ),
    
    /** The UNIT_FIELD_BYTES_1
     *  Flags: PUBLIC
     */
    UNIT_FIELD_BYTES_1( OBJECT_END + 0x0044, 1, BYTES ),
    
    /** The UNIT_FIELD_PETNUMBER
     *  Flags: PUBLIC
     */
    UNIT_FIELD_PETNUMBER( OBJECT_END + 0x0045, 1, INT ),
    
    /** The UNIT_FIELD_PET_NAME_TIMESTAMP
     *  Flags: PUBLIC
     */
    UNIT_FIELD_PET_NAME_TIMESTAMP( OBJECT_END + 0x0046, 1, INT ),
    
    /** The UNIT_FIELD_PETEXPERIENCE
     *  Flags: OWNER
     */
    UNIT_FIELD_PETEXPERIENCE( OBJECT_END + 0x0047, 1, INT ),
    
    /** The UNIT_FIELD_PETNEXTLEVELEXP
     *  Flags: OWNER
     */
    UNIT_FIELD_PETNEXTLEVELEXP( OBJECT_END + 0x0048, 1, INT ),
    
    /** The UNIT_DYNAMIC_FLAGS
     *  Flags: DYNAMIC
     */
    UNIT_DYNAMIC_FLAGS( OBJECT_END + 0x0049, 1, INT ),
    
    /** The UNIT_MOD_CAST_SPEED
     *  Flags: PUBLIC
     */
    UNIT_MOD_CAST_SPEED( OBJECT_END + 0x004A, 1, FLOAT ),
    
    /** The UNIT_CREATED_BY_SPELL
     *  Flags: PUBLIC
     */
