...
public enum UnitField implements UpdateField {
    ...
    UNIT_FIELD_POWER_1_REGEN_FLAT_MODIFIER(OBJECT_END + 0x0023, 1, FLOAT), // ; Flags: PRIVATE;
                                                                           // OWNER
    UNIT_FIELD_POWER_2_REGEN_FLAT_MODIFIER(OBJECT_END + 0x0024, 1, FLOAT), // ; Flags: PRIVATE;
                                                                           // OWNER
    UNIT_FIELD_POWER_3_REGEN_FLAT_MODIFIER(OBJECT_END + 0x0025, 1, FLOAT), // ; Flags: PRIVATE;
                                                                           // OWNER
    UNIT_FIELD_POWER_4_REGEN_FLAT_MODIFIER(OBJECT_END + 0x0026, 1, FLOAT), // ; Flags: PRIVATE;
                                                                           // OWNER
    UNIT_FIELD_POWER_5_REGEN_FLAT_MODIFIER(OBJECT_END + 0x0027, 1, FLOAT), // ; Flags: PRIVATE;
                                                                           // OWNER
    UNIT_FIELD_POWER_6_REGEN_FLAT_MODIFIER(OBJECT_END + 0x0028, 1, FLOAT), // ; Flags: PRIVATE;
                                                                           // OWNER
    
    /** The UNI t_ fiel d_ powe r_ rege n_ interrupte d_ fla t_ modifier. */
    UNIT_FIELD_POWER_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x0029, 7, FLOAT), // ; Flags:
                                                                                     // PRIVATE;
                                                                                     // OWNER
    
    UNIT_FIELD_POWER_1_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x002A, 7, FLOAT), // ; Flags:
                                                                                       // PRIVATE;
                                                                                       // OWNER
    UNIT_FIELD_POWER_2_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x002B, 7, FLOAT), // ; Flags:
                                                                                       // PRIVATE;
                                                                                       // OWNER
    UNIT_FIELD_POWER_3_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x002C, 7, FLOAT), // ; Flags:
                                                                                       // PRIVATE;
                                                                                       // OWNER
    UNIT_FIELD_POWER_4_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x002D, 7, FLOAT), // ; Flags:
                                                                                       // PRIVATE;
                                                                                       // OWNER
    UNIT_FIELD_POWER_5_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x002E, 7, FLOAT), // ; Flags:
                                                                                       // PRIVATE;
                                                                                       // OWNER
    UNIT_FIELD_POWER_6_REGEN_INTERRUPTED_FLAT_MODIFIER(OBJECT_END + 0x002F, 7, FLOAT), // ; Flags:
                                                                                       // PRIVATE;
                                                                                       // OWNER
